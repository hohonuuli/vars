/*
 * @(#)FatalErrorSubscriber.java   2009.09.23 at 11:20:03 PDT
 *
 ...
 * @author brian
 */
public class FatalErrorSubscriber implements EventTopicSubscriber<Exception> {

    public static final String TOPIC_FATAL_ERROR = "Fatal Error Topic";
     ...
     * @param parent
     */
    public FatalErrorSubscriber(Frame parent) {
