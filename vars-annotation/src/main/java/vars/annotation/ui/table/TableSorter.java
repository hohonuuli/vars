 ...
 */
public class TableSorter extends ObservationTableModel {
     ...
     *
     */
    private static final long serialVersionUID = 4371997815099695823L;
    ...
    /**
     *     @uml.property  name="modelRowCount"
     */
     ...
     *     @uml.associationEnd  multiplicity="(0 -1)" elementType="org.mbari.vars.annotation.ui.table.TableSorter$Directive"
     */
     ...
     *     @uml.associationEnd  multiplicity="(0 -1)" inverse="this$0:org.mbari.vars.annotation.ui.table.TableSorter$Row"
     */
    ...
    protected Comparator getComparator(final int column) {
        final Class columnType = getColumnClass(column);
    ...
    private int[] getModelToView() {
        if ((modelToView == null) || (getRowCount() != modelRowCount)) {
            modelRowCount = getRowCount();
...
//          modelToView = new int[n];
    ...
    public Observation getObservationAt(final int rowIndex) {
        return super.getObservationAt(modelIndex(rowIndex));
    }
    ...
    public int getObservationRow(final Observation observation) {
        final int row = super.getObservationRow(observation);
        int out = 0;
        if (row > 0) {
            final int[] a = getModelToView();
            out = a[row];
        }

        if (log.isDebugEnabled()) {
            log.debug(observation + " was found at row = " + out);
        }
    ...
    public Object getValueAt(final int row, final int column) {
        return super.getValueAt(modelIndex(row), column);
    }
    ...
    private synchronized Row[] getViewToModel() {
        if ((viewToModel == null) || (modelRowCount != getRowCount())) {
            final int tableModelRowCount = getRowCount();
            modelRowCount = tableModelRowCount;
    ...
    public void setValueAt(final Object aValue, final int row, final int column) {
        super.setValueAt(aValue, modelIndex(row), column);
    }
    ...
    private static class Arrow implements Icon {
         ...
         * @param priority
         */
        public Arrow(boolean descending, final int size, final int priority) {
    ...
    private class MouseHandler extends MouseAdapter {
        ...
        public void mouseClicked(final MouseEvent e) {
            ...
            if (!((ValueColumn) columnModel.getColumn(viewColumn)).isSortable()) {
                setSortingStatus(viewColumn, NOT_SORTED);
    ...
    private class Row implements Comparable {
        ...
        public int compareTo(final Object o) {
            ...
            for (final Iterator it = sortingColumns.iterator(); it.hasNext(); ) {
                ...
                final Object o1 = TableSorter.super.getValueAt(row1, column);
                final Object o2 = TableSorter.super.getValueAt(row2, column);
                int comparison = 0;
