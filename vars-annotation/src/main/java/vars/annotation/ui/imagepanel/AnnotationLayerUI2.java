 ...
 * @param <T>
 */
public class AnnotationLayerUI2<T extends JImageUrlCanvas> extends MultiLayerUI<T> {
     ...
     */
    public AnnotationLayerUI2(ToolBelt toolBelt, UIDataCoordinator dataCoordinator) {
    ...
    private class Controller {
        ...
        void sendSelectionNotification(Collection<Observation> selectedObservations) {
            EventBus.publish(new ObservationsSelectedEvent(AnnotationLayerUI2.this, selectedObservations));
        }
    }
}
