...
public class VideoSourcePanelTape extends javax.swing.JPanel implements IVideoSourcePanel {
    ...
    private OpenVideoArchiveUsingParamsAction openAction = new OpenVideoArchiveUsingParamsAction();
    private boolean validVideoSource = true;
    
    /** Creates new form VideoSourcePanelTape */
    public VideoSourcePanelTape() {
        initComponents();
        postInit();
    }
...
//                (tapeNumberTextField.getText() != null) &&
//                (!tapeNumberTextField.getText().equals(""));
