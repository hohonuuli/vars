/*
 * @(#)IVideoArchiveSet.java   2008.12.30 at 01:50:53 PST
 *
...
public interface IVideoArchiveSet extends IAnnotationObject {
     ...
     */
    IVideoArchive getVideoArchiveByName(final String videoArchiveName);
     ...
     * @param va
     */
    void removeVideoArchive(IVideoArchive va);
     ...
     * @uml.property  name="cameraPlatformDeploymentColl"
     */
    //void setCameraPlatformDeployments(Collection<? extends ICameraDeployment> platformUsageCollToSet);
